...
(function($) {
	...
	doGraph = function(el){
			...
			$(el).append(out);
 			...
 			if(valueData instanceof Array){
				...
				for (i in valueData){
					...
					if(valueExc[i] == "")
					{
							o = "<div class='subBars"+el.id+"' id='"+exccounter+"' style='height:"+heig+"px; background-color: "+arr.colors[i]+"; left:"+wid*i+"px; color:"+arr.showValuesColor+"; font-size:"+fs+"px' >"+sv+"%"+"</div>";
					}
					else
					{
							o = "<div class='subBars"+el.id+"' id='"+exccounter+"' style='height:"+heig+"px; background-color: "+arr.colors[i]+"; left:"+wid*i+"px; color:"+arr.showValuesColor+"; font-size:"+fs+"px' >"+sv+"%"+"<br /><br /><img src='images/exception.png'> "+"</div>";
					}
		...
		/*
					//To show exceptions in a tool-tip
					
					function show_exception(bind_element) {
			...
			*/		
					...
					jQuery.each(exc_res, function() {
							if(this[0] == "")
								this[0] = "<h3><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Exceptions List___</u></h3><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO EXCEPTIONS";
							if(this[1] == "")
								this[1] = "<h3><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Exceptions List___</u></h3><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO EXCEPTIONS";
							if(this[2] == "")
								this[2] = "<h3><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Exceptions List___</u></h3><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO EXCEPTIONS";
					});
